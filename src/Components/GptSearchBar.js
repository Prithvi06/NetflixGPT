...
const GptSearchBar = () => {
    ...
    return (
        <div className="pt-[30%] lg:pt-[10%] md:pt-[15%] sm:[pt-20%] text-center">
            <form className="bg-black w-full md:w-1/2 m-auto grid grid-cols-12" onSubmit={(e) => e.preventDefault()}>
